...
BOARD = [
    ...
    ("Piet Maes", "President Elect | Belgium", "board/piet-maes.jpg?v=piet-unified-border3-20260603", "https://orcid.org/0000-0002-4571-5232"),
...
SCIENTIFIC_COMMITTEE = [
    ...
    ("Piet Maes", "President Elect ISH", "Universite libre de Bruxelles", "Belgium", "board/piet-maes.jpg?v=piet-unified-border3-20260603", "https://orcid.org/0000-0002-4571-5232"),
...
def committee_teaser(prefix: str) -> str:
    highlights = [
        ...
        ("Piet Maes", "President Elect ISH", "board/piet-maes.jpg?v=piet-unified-border3-20260603"),
