...
BOARD = [
    ...
    ("Piet Maes", "President Elect | Belgium", "ich2026/scientific-piet-maes.jpg?v=piet-crop-20260603", "https://orcid.org/0000-0002-4571-5232"),
...
SCIENTIFIC_COMMITTEE = [
    ...
    ("Piet Maes", "President Elect ISH", "Universite libre de Bruxelles", "Belgium", "ich2026/scientific-piet-maes.jpg?v=piet-crop-20260603", "https://orcid.org/0000-0002-4571-5232"),
...
def committee_teaser(prefix: str) -> str:
    highlights = [
        ...
        ("Piet Maes", "President Elect ISH", "ich2026/scientific-piet-maes.jpg?v=piet-crop-20260603"),
